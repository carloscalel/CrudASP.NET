...
namespace CrudASP.NET.Controllers
{
    ...
    public class VentasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "VentaId,ProductoId,Cantidad,PrecioUnitario,Total,FechaVenta,Observaciones")] Ventas ventas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "VentaId,ProductoId,Cantidad,PrecioUnitario,Total,FechaVenta,Observaciones")] Ventas ventas)
        {
            if (ModelState.IsValid)
            {
